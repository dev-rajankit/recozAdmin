...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  useEffect(() => {
    try {
      ...
      console.error('Failed to read authUser from sessionStorage:', error);
    }
    setLoading(false);
  }, []);
  ...
  const login = async (email: string, pass: string) => {
    ...
    try {
      ...
      console.error('Failed to write authUser to sessionStorage:', error);
    }
    setUser(userData);
  };
  ...
  const logout = () => {
    try {
      ...
      console.error('Failed to remove authUser from sessionStorage:', error);
    }
    setUser(null);
  };
